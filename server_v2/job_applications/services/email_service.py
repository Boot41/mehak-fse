...
class EmailService:
        ...
        try:
            ...
            try:
                result = EmailService._send_via_gmail_api(
                    ...
                    subject=f'Follow-up: {application.position} at {application.company_name}',
                    body=email_content,
    ...
    @staticmethod
    def _generate_follow_up_content(application: JobApplication) -> str:
...
I hope this email finds you well. I am writing to follow up on my application for the {application.position} position at {application.company_name}. I submitted my application on {application.application_date.strftime('%B %d, %Y')}.
...
Best regards,
{application.user.get_full_name() or application.user.email}"""
